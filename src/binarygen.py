...
class BinaryGenerator:
    ...
    def __init__(self, hexmode, dictonary):
        self.bitlength = math.ceil(math.log2(dictionary["REGFILE_SIZE"]))
        self.dataWidth = math.ceil(math.log2(dictionary["DATA_WIDTH"]))
